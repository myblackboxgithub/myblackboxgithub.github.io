...
namespace MyActivities
{
    ...
    public sealed partial class App : Application
    {
        ...
        //creates channel to notifications hubs
        private async void InitNotificationsAsync()
        {
            var channel = await PushNotificationChannelManager.CreatePushNotificationChannelForApplicationAsync();

            var hub = new NotificationHub("mainhub2", "Endpoint=sb://notificationhub-nss.servicebus.windows.net/;SharedAccessKeyName=DefaultListenSharedAccessSignature;SharedAccessKey=a0xTRk4MKUKHMq8qPr7y0D+N8oW6gQ2CKL1EK6H0byI=");
            ...
            if (result.RegistrationId != null)
            {
                ...
                var dialog = new MessageDialog("Youre registered with hub");
